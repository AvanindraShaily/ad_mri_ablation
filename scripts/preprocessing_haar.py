...
INPUT_DIR = os.path.join(PROJECT_ROOT, "datalib", "sachin_kumar_ad_dataset")
...
def haar_preprocess(image_path, target_size=TARGET_SIZE):
    ...
    # Original image as 3 RGB channels
    channels = [img_array, img_array, img_array]

    # Add wavelet subbands
    ...
    # Resize original channels to target size too
    for i in range(3):
